...
## Implementação - Jéssica Lima

### O que foi implementado
- Estrutura inicial do backend com NestJS
- Integração Inicial com Prisma e Postgres
- Endpoint GET para listagem de pacientes
- Organização em modules, controllers e services.
- Criação de component de paciente no frontend (Angular)
- Implementação de tabela utilizando Angular Material para exibir dados de pacientes.

### Observações
Devido ao prazo e a complexidade da stack proposta, priorizei garantir o funcionamento da base do backend e a estrutura correta da aplicação. Com mais tempo, o próximo passo seria evoluir os endpoints, validações, regras de negócio, teste de integração e melhoria de frontend.
